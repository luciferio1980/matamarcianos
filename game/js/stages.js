...
AR.Stages = {
  build: function (id, extra) {
    ...
    if (id === 0) this._steel(at, wave, formV, extra);
    if (id === 1) this._ocean(at, wave, formV, extra);
    if (id === 2) this._red(at, wave, formV, extra);
    if (id === 3) this._neon(at, wave, formV, extra);
    if (id === 4) this._bio(at, wave, formV, extra);
    if (id === 5) this._core(at, wave, formV, extra);
    ev.sort(function (a, b) { return a.t - b.t; });
    return ev;
  },

  _steel: function (at, wave, formV, extra) {
    ...
    at(70, function (g) { g.startBoss(); });
  },

  _ocean: function (at, wave, formV, extra) {
    ...
    at(68, function (g) { g.startBoss(); });
  },

  _red: function (at, wave, formV, extra) {
    ...
    at(72, function (g) { g.startBoss(); });
  },

  _neon: function (at, wave, formV, extra) {
    ...
    at(41, function (g) { g.scrollMul = 1; g.tunnel = 0; g.toast("CIRCUITO MEDIANOCHE"); });
  ...
  _bio: function (at, wave, formV, extra) {
  ...
  _core: function (at, wave, formV, extra) {
    ...
    at(78, function (g) { g.scrollMul = 1; g.startBoss(); });
  }
};
